...
def nwb_to_pandas(path_to_file):
    '''This function opens a neurodata without borders file (.nwb), extracts the time
    series data, and returns a pandas DataFrame'''
    ...
    data_df = pd.DataFrame(raw_series).T
    data_df.columns = vc_sweeps.sweep_number
